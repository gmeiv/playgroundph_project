<?php
$host = 'localhost';
$user = 'u778263593_root';
$pass = 'PlaygroundPH00'; // your MySQL password
$db   = 'u778263593_playgroundph';

$conn = new mysqli($host, $user, $pass, $db);
if ($conn->connect_error) die("Connection failed: " . $conn->connect_error);

// Get players sorted by score DESC
$sql = "SELECT player, wins, losses, total_score FROM chain_scores ORDER BY total_score DESC";
...
<html>
<head>
    <title>Chain Reaction - Leaderboard</title>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        $totalGames = $totalGames / 2; // Each game has multiple players
        ?>
        ...
        <table>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()):
                    ...
                    $winRate = ($totalGamesPlayed > 0) ? 
                              round(($row['wins'] / $totalGamesPlayed) * 100, 1) : 0;
        ...
        <div class="navigation">
            <a href="homepage.php" class="nav-button" id="lobbyBtn">Lobby</a>
        </div>
    </div>
